                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check card-radio">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="1"
                                                                {{ $laporan->firstPendukung->tingkat_kerusakan->value == 1 ? 'checked' : '' }} />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check card-radio">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="2"
                                                                {{ $laporan->firstPendukung->tingkat_kerusakan->value == 2 ? 'checked' : '' }} />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check card-radio">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="3"
                                                                {{ $laporan->firstPendukung->tingkat_kerusakan->value == 3 ? 'checked' : '' }} />
