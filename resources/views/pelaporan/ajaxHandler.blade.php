<script>
        ...
        dataPelaporan = $('#table_pelaporan').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                        <a href="{{ url('/pelaporan/${row.id_laporan}/show') }}" class="btn btn-soft-info btn-sm"><i class="bx bx-show-alt"></i> Peninjauan</a>
                    `;
                    }
                }
            ]
    ...
    $(document).ready(function() {
        dataPelaporanPeninjauan = $('#table_pelaporan_peninjauan').DataTable({
            processing: true,
            serverSide: true,
            stateSave: true,
            ajax: {
