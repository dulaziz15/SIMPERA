<form action="{{ url('/gedung/' . $gedung->id_gedung . '/update') }}" method="POST" id="form-tambah" class="needs-validation">
    @csrf
    @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_kategori_gedung" {{-- data-trigger --}}
                                        ...
                                        @foreach ($kategori as $l)
                                            <option {{ $l->id_kategori_gedung == $gedung->id_kategori_gedung ? 'selected' : '' }} value="{{ $l->id_kategori_gedung }}">{{ $l->kategori_gedung }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode" id="kode" value="{{ $gedung->kode }}"
                                        class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" rows="5" class="form-control" required>{{ $gedung->deskripsi }}</textarea>
