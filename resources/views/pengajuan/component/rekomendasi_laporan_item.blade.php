        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn btn-sm btn-warning rounded-pill px-3 action-btn" data-bs-toggle="modal"
                    data-bs-target="#ajukanModal" data-id="{{ $item->id_laporan }}">
                    <i class="fas fa-paper-plane me-1"></i> Ajukan
                </button>
                <!-- Submission Modal -->
                <div class="modal fade" id="ajukanModal" tabindex="-1" aria-labelledby="ajukanModalLabel"
                    aria-hidden="true">
                    @include('pengajuan.component.modal_ajukan', ['item' => $item]);
                </div>
            </div>
        </div>
    </div>
