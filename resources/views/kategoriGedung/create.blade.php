<form action="{{ url('/kategori_gedung/store') }}" method="POST" id="form-tambah" class="needs-validation">
    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group">
                                    ...
                                    <input type="text" name="kategori_gedung" id="kategori_gedung" value=""
                                        class="form-control">
...
<script>
    $(document).ready(function() {
        $('#form-tambah').validate({
            ...
            messages: {
                kategori_gedung: {
                    required: "Nama kategori Gedung wajib diisi.",
