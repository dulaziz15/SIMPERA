...
<!-- Mirrored from themesbrand.com/minia/layouts-lts/pages-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 May 2025 10:17:58 GMT -->
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <h4 class="text-uppercase">Forbidden. Kamu tidak punya akses ke halaman ini</h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-xl-8">
                        <div>
                            <img src="{{ asset('template/assets/images/error-img.png')}}" alt="" class="img-fluid">
                        </div>
                    </div>
                    <!-- end row -->
                </div>
...
<!-- Mirrored from themesbrand.com/minia/layouts-lts/pages-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 May 2025 10:17:59 GMT -->
</html>
