                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            ...
                            <h4 class="mb-3">
                                <span class="counter-value" data-target="{{ $laporanThisPeriode->count() }}">0</span>
                            </h4>
                        </div>
                    </div>
                    <div class="text-nowrap">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span
                                                class="badge bg-{{ $item->status->color() }} rounded-pill py-1 px-2">
                                                {{ $item->status->label() }}
                                            </span>
                                        </div>
                                        <span
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                ...
                <div class="card-body d-flex flex-column">
                    <div class="total mb-3">
                        Jumlah Seluruh Laporan <span class="badge bg-primary">{{ $laporanThisPeriode->count() }}</span>
                    </div>
        ...
        <script>
            ...
            option = null, option = {
                ...
                series: [{
                    ...
                    data: [{
                        value: {{ $laporanThisPeriode->filter(function ($item) {
