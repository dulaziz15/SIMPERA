							...
							<div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s"
								...
								<div class="advisor_thumb">
									<img src="{{ asset('storage/foto_profil/' . $profil->profil->foto_profil) }}" alt=""
										style="img-fluid object-fit-cover hover-zoom" class="ratio ratio-1x1 rounded-3 overflow-hidden bg-light">

									<a onclick="modalUpdateImage('{{ $profil->profil->id_profil }}')" class="btn-edit-foto" title="Edit Foto">
