    <form action="{{ url('/periode/' . $periode->id_periode . '/update') }}" method="post" id="form-update">
        @csrf
        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_periode" id="nama_periode" value="{{ $periode->nama }}"
                                            class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="budget_perbaikan" id="budget_perbaikan"
                                            value="{{ $periode->biaya }}" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ $periode->tanggal_mulai }}"
                                            class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ $periode->tanggal_selesai }}"
                                            class="form-control">
