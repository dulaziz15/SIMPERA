<form action="{{ url('/user/' . $user->id_pengguna . '/store-profil') }}" enctype="multipart/form-data" method="POST" id="form-tambah" class="needs-validation">
	@csrf
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="file" name="foto_profil" id="foto_profil" value="" class="form-control">
