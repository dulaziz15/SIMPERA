		...
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<button onclick="modalAction('{{ url('user/create') }}')" class="btn btn-sm btn-success mt-1">Tambah</button>
				</div>
				<div class="card-tools">
			...
			<div class="card-body" id="user-list">
				...
				<table class="table table-bordered table-striped table-hover table-sm nowrap w-100 dt-responsive" id="table_user">
