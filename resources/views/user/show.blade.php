										...
										<div class="btn-group">
											...
											<div class="dropdown-menu">
												<button class="dropdown-item"
													onclick="modalProfil('{{ url('user/' . $user->id_pengguna . '/edit_profil') }}')"
													data-bs-dismiss="modal"><i class="bx bx-edit"></i> Edit</button>
												<button class="dropdown-item" onclick="modalProfil('{{ url('user/' . $user->id_pengguna . '/confirm') }}')"
													data-bs-dismiss="modal"><i class="bx bx-trash"></i> Hapus</button>
											</div>
										</div>
									</div>
								</div>
